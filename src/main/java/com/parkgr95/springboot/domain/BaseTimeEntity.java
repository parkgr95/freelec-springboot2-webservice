package com.parkgr95.springboot.domain;
...
@EntityListeners(AuditingEntityListener.class) // BasteTimeEntity 클래스에 Auditing 기능을 포함시킨다.
// Auditing: 시간에 대해서 자동으로 값을 넣어주는 기능
